...
for turn in range(4): # The number of turns the player gets
    ...
    if guess_row == ship_row and guess_col == ship_col: # If player guesses correctly
        ...
        break
    elif guess_row not in range(6) or guess_col not in range(6): # If player guesses outside of the grid
        print "Oops, that's not even in the ocean."
    elif guess_row == "X" or guess_col == "X": # If a player's guess is the same as a previous guess
